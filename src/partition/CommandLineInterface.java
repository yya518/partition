...
public class CommandLineInterface {
	protected static final String DEFAULT_USAGE = "[-h] [-n] [-t] [-f]";
	...
	public void addOption(){
		...
		options.addOption("f", "file", true, "The absolute corpus file path");
	}
    /**
    ...
    protected void validateCommandLine(final CommandLine cmdLine) throws ParseException{
    	if ( cmdLine.hasOption("h") )
    		printHelpAndExit();
    	if ( !cmdLine.hasOption("n") || !cmdLine.hasOption("t") || !cmdLine.hasOption("f") )
    		throw new ParseException(
                    "n, t, f are required arguments");
    }
